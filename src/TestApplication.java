...
//		System.out.println(formationDao.readAllOnsiteFormation());
		...
		// Test des méthode CRUD CategoryDao:
//		Category foodFormationCategory = new Category("Formation Cuisine", "Formation culinaire");
//		System.out.println(categoryDao.create(foodFormationCategory));
//		
//		System.out.println(categoryDao.read(5));
//		
//		foodFormationCategory = new Category(5, "Formation de Patîsserie", "Formation culinaire");
//		
//		System.out.println(categoryDao.update(foodFormationCategory));
//		System.out.println(categoryDao.read(5));
//		
//		System.out.println(categoryDao.readAll());
//		System.out.println(categoryDao.delete(foodFormationCategory));
//		System.out.println(categoryDao.readAll());
